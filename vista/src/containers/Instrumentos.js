...
export var getadminInstrumentos = function (callback) {
...
export var getInstrumentos = function (callback) {
    var url = URLUKA + "/Miembros/IN/Admin/AdminIN.aspx/getInstrumentos";
    var idGrupo = localStorage.getItem("UKAidGrupo")
    var params = {
        idGrupo: idGrupo,
...
export var getInstrumentoById = function (id, callback) {
...
export var getReactivosrespuestasbyModuloId = function (id, callback) {
...
export var getModuloById = function (id, callback) {
...
//
export var getCandidatos = function (filters, callback) {
    if (filters._instrumentoId) {
        var url = URLUKA + "/Miembros/WS/APP.aspx/getCandidatos";
        var idGrupo = localStorage.getItem("UKAidGrupo")
        var params = {
...
export var setReactivo = function (params, callback) {
    var url = URLUKA + "/Miembros/WS/APP.aspx/setReactivo";
    var params = {
...
export var getAplicacionInstrumento = function (params, callback) {
    var url = URLUKA + "/Miembros/WS/APP.aspx/getAplicacionInstrumento";
    var params = {
...
export var getReactivo = function (params, callback) {
    var url = URLUKA + "/Miembros/WS/APP.aspx/getReactivo";
    var params = {
        aplicacionReactivoInstrumento: params.aplicacionReactivoInstrumento,
    };
    axios
...
export var getTreeReactivos = function (params, callback) {
    var url = URLUKA + "/Miembros/WS/APP.aspx/getTreeReactivos";
    var params = {
        aplicacionIdCurrentEncuesta: params.aplicacionIdCurrentEncuesta,
    };
    axios
...
export var handleGenerateAplicacionInstrumento = function (params, callback) {
    var url = URLUKA + "/Miembros/WS/APP.aspx/handleGenerateAplicacionInstrumento";
    var idGrupo = localStorage.getItem("UKAidGrupo")
    var params = {
        aplicacionIdCurrentEncuesta: params.aplicacionIdCurrentEncuesta,
...
export var deleteInstrumento = function (id, callback) {
...
export var deleteModulo = function (id, callback) {
...
export var searchByPrefijo = function (params, callback) {
...
export var saveInstrumento = function (state, callback) {
...
export var saveModulo = function (state, callback) {
